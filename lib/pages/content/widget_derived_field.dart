...
class WidgetDerivedField extends StatefulWidget {
  const WidgetDerivedField({
    super.key,
  ...
  @override
  State<WidgetDerivedField> createState() => WidgetDerivedFieldState();
}

class WidgetDerivedFieldState extends State<WidgetDerivedField>
    with WidgetHelper {
  @override
                  ...
                  child: GestureDetector(
                    onTap: () {
                      ComputedValue cv = ComputedValue(
                        id: shortid.generate(),
                        expression: '',
                        name: mapping.pathDest?.info.name ?? 'computed',
                      );
                          ...
                          widget.listMapping
                              .map(
                                (m) => ComputedValue(
                                  id: shortid.generate(),
                                  expression: '',
                                  name: m.pathDest?.info.name ?? 'computed',
                                ),
                              )
                              .toList();
