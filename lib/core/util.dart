...
Map getOpenApiSpec(dynamic servers, dynamic path, dynamic cmp, String surl) {
  ...
  final Map openApi = {
    ...
    'info': {
      ...
      'version': '0.0.1',
      'description':
          '''Preview of the API generated by Api architect based on the model design. 
\nThis specification is auto-generated and may not be fully compliant with OpenAPI standards. 
\nIt is intended for preview purposes only.
\nby Api ArCHITECT - ${DateTime.now()}   
\nlink [https://apiarchitec.netlify.app](https://apiarchitec.netlify.app/#/$surl)          
            ''',
    },
    'servers': servers,
