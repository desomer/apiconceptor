...
class FrozenTableView extends StatefulWidget {
  ...
  final Widget Function(int row, Widget child) buildRow;
...
class _FrozenTableViewState extends State<FrozenTableView> {
  ...
  double getWitdh(int start, int end) {
    double total = 0;
  ...
  // // Coin gelé (haut gauche / bas gauche)
  // Widget _cornerCellTop() {
  //   return Container(
  //     width: widget.leftColWidth * widget.colFreezeLeftCount,
  //     height: widget.rowHeight * widget.rowCountTop,
  //     color: Colors.grey.shade300,
  //   );
  // }

  // Widget _cornerCellBottom() {
  //   return Container(
  //     width: widget.leftColWidth * widget.colFreezeLeftCount,
  ...
  Widget _topFrozenRow() {
    var witdh = getWitdh(widget.colFreezeLeftCount, widget.colCount);
          ...
          child: ListView.builder(
            ...
            itemBuilder:
                (_, row) => SizedBox(
                  ...
                  //   itemBuilder:
                  //       (_, col) => SizedBox(
                  //         width: widget.getColWidth(
                  //           col + widget.colFreezeLeftCount,
                  //         ),
                  //         height: widget.getRowHeight(row),
                  //         child: widget.buildTopCell(
                  //           row,
                  //           col + widget.colFreezeLeftCount,
                  //         ),
                  //       ),
          ...
          child: ListView.builder(
            ...
            itemBuilder:
                (_, row) => SizedBox(
                  ...
                  //   //controller: horizontal2,
                  //   scrollDirection: Axis.horizontal,
                  //   itemCount: widget.colCount - widget.colFreezeLeftCount,
                  //   itemBuilder:
                  //       (_, col) => SizedBox(
                  //         width: widget.getColWidth(
                  //           col + widget.colFreezeLeftCount,
  ...
  Widget _topFrozenColumn() {
    var witdh = getWitdh(0, widget.colFreezeLeftCount);
    return SizedBox(
        ...
        itemBuilder:
            (_, row) => SizedBox(
              ...
              child: widget.buildRow(
                ...
                //   scrollDirection: Axis.horizontal,
                //   primary: false,
                //   itemCount: widget.colFreezeLeftCount,
                //   itemBuilder: (_, col) {
                //     print("col $col row $row");
                //     return SizedBox(
                //       height: widget.getRowHeight(row),
                //       width: widget.getColWidth(col),
                //       child: widget.buildLeftCell(row, col),
                //     );
                //   },
                // ),
              ),
