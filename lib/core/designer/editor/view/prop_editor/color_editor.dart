...
class _HexColorEditorState extends State<HexColorEditor> with HelperEditor {
  ...
  void _updateColor(Color c) {
    var hexString = currentColor?.toHexString();
    var hexString2 = c.toHexString();
    if (hexString == hexString2) return;
                ...
                return AlertDialog(
                  ...
                  content: SizedBox(
                    ...
                    child: WidgetTab(
                      ...
                      listTabCont: [
                        MaterialPicker(
                          pickerColor: currentColor ?? Colors.transparent,
